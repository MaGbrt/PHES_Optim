...
from Surrogates.ExactGPModel import ExactGPModel
...
class GP(Surrogate):
    ...
    def __init__(self, f_sim_archive, pb, n_train_samples, f_train_log, f_trained_model, kernel):
        ...
        self.__model = ExactGPModel(x_train, y_train, self.__likelihood, self.__kernel)
    ...
    def perform_training(self):
        ...
        #print('Iter %d/%d - Loss: %.3f ' % (i + 1, iterations_num, loss.item() ))
