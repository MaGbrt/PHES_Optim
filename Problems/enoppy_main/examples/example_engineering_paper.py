...
p1 = moeosma_2023.MultiProductBatchPlantProblem()

from enoppy.paper_based import ihaoavoa_2022
p1 = ihaoavoa_2022.RollingElementBearingProblem()

from enoppy.paper_based import rwco_2020
p1 = rwco_2020.MultiProductBatchPlantProblem()
print(p1.get_paras())
print(p1.bounds)
print(p1.n_dims)
print(p1.n_objs)
